...
boton10=Button(ventana,text="^",bd=6,bg="#102E59",fg="white",command=lambda:almacenar("**"),width=5).place(x=280,y=160)
...
boton15=Button(ventana,text="pi",bd=6,bg="#102E59",fg="white",command=lambda:almacenar("pi"),width=5).place(x=280,y=200)
